...
<body>
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="${ctx}"><img src="${ctxStatic}/images/logo.png" alt="Cloudroom Admin" style="height:40px;"></a>
        </div>
      </div>
    </div>
    ...
    <div class="container">
        ...
        <div id="login-wraper">
            <form id="loginForm"  class="form login-form" action="${ctx}/login" method="post">
                ...
                <div class="footer">
                   <h4><span style="color:#08c;"><a href="${ctx}/register">
					注册</a></span></h4>
                </div>
    ...
    <footer class="white navbar-fixed-bottom">
		Copyright &copy; 2012-${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> - Powered By <a href="https://github.com/thinkgem/jeesite" target="_blank">Cloudroom</a> ${fns:getConfig('version')}
    </footer>
  </body>
</html>