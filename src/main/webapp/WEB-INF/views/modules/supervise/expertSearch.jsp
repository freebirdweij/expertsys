...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
			$("#pageNo").val(n);
			$("#pageSize").val(s);
			$("#searchForm").attr("action","${ctx}/supervise/expertsearch");
			$("#searchForm").submit();
	    	return false;
	    }
	</script>
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/supervise/projectsearch">查询项目</a></li>
		<li class="active"><a href="${ctx}/supervise/expertsearch">查询专家</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="expertConfirm" action="${ctx}/supervise/expertsearch" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="expertConfirm">
			<tr>
				...
				<td>
    				<a href="${ctx}/supervise/checkexpertfetch?expid=${expertConfirm.id}">查看抽取记录</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
