...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sys/user/form?id=${user.id}">用户注册</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/register" method="post" class="form-horizontal">
		<form:hidden path="id"/>
