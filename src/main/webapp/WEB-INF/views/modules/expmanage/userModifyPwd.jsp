...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/expmanage/modifyPwd?id=${id}">修改密码</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/expmanage/modifyPwd" method="post" class="form-horizontal">
		<form:hidden path="id"/>
