...
<head>
	...
	<script type="text/javascript">
		...
		function resBack(){
			$("#inputForm").attr("action","${ctx}/expfetch/acptredraw/backunitresult");
			$("#inputForm").submit();
	    	return false;
	    }
...
<body>
	...
	<form:form id="inputForm" modelAttribute="projectExpert" action="${ctx}/expfetch/acptredraw/drawunitexpert" method="post" class="form-horizontal">
