...
//		toStyle.setFont(fromStyle.getFont(null));
	 ...
	 * @param copyValueFlag
	 */
	public static void copySheet(SXSSFWorkbook wb,HSSFSheet fromSheet, HSSFSheet toSheet,
	 ...
	 * @param toRow
	 */
	public static void copyRow(SXSSFWorkbook wb,Row fromRow,Row toRow,boolean copyValueFlag){
	...
	*/
	 ...
	 *            true则连同cell的内容一起复制
	 */
	public static void copyCell(SXSSFWorkbook wb,Cell srcCell, Cell distCell,
			boolean copyValueFlag) {
