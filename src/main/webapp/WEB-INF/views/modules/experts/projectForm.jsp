		...
		<div class="control-group">
			...
			<div class="controls">
				从<form:input path="prjBegin" maxlength="20"
						class="span2 input-small Wdate" value="${projectInfo.prjBegin}" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});" />
				至<form:input path="prjEnd" maxlength="20"
						class="span2 input-small Wdate" value="${projectInfo.prjEnd}" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});" />
			</div>
		</div>
		<div class="control-group">
