		...
		<c:forEach items="${page.list}" var="projectInfo">
			<tr>
				...
				<shiro:hasPermission name="project:projectInfo:edit"><td>
    				<a href="${ctx}/expfetch/rewredraw/acptfetch/unitmethod?prjid=${projectInfo.id}">单位方式抽取</a>
    				<a href="${ctx}/expfetch/rewredraw/acptfetch/expertmethod?prjid=${projectInfo.id}">专家个人方式抽取</a>
