...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/expmanage/worknew?id=${id}">专家职业信息</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="expertInfo" action="${ctx}/expmanage/addwork" method="post" class="form-horizontal">
