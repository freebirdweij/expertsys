...
<head>
	...
	<script type="text/javascript">
		...
		function page(n, s) {
			$("#pageNo").val(n);
			$("#pageSize").val(s);
			$("#inputForm").attr("action", "${ctx}/expfetch/acptfetch/expertfetch?repage=1");
			$("#inputForm").submit();
			return false;
		}
		function rSubmit() {
			$("#inputForm").attr("action",
					"${ctx}/expfetch/acptfetch/receiveexpertresult");
			$("#inputForm").submit();
			return false;
		}
		...
		function rCancel() {
			$("#inputForm")
					.attr("action", "${ctx}/expfetch/acptfetch/cancelexpertresult");
			$("#inputForm").submit();
			return false;
		}

		function bCancel() {
			$("#inputForm").attr("action", "${ctx}/expfetch/acptfetch/backexpmethod");
			$("#inputForm").submit();
			return false;
		}
...
<body>
	...
	<form:form id="inputForm" modelAttribute="projectExpert" action="${ctx}/expfetch/acptfetch/directdrawexpert" method="post" class="form-horizontal">
