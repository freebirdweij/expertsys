...
<head>
	...
	<script type="text/javascript">
		...
		function rSubmit(){
			$("#inputForm").attr("action","${ctx}/expfetch/savefetch/export");
			$("#inputForm").submit();
	    	return false;
	    }
		...
		function bCancel(){
			$("#inputForm").attr("action","${ctx}/expfetch/savefetch/reviewinglist");
			$("#inputForm").submit();
	    	return false;
	    }
...
<body>
	...
	<form:form id="inputForm" modelAttribute="projectExpert" action="${ctx}/expfetch/savefetch/directdrawunit" method="post" enctype="multipart/form-data" class="form-horizontal">
