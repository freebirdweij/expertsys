	...
	<script type="text/javascript">
		...
		function rSubmit() {
			$("#inputForm").attr("action",
					"${ctx}/expfetch/acptredraw/receiveexpertresult");
			$("#inputForm").submit();
			return false;
		}
		...
		function rCancel() {
			$("#inputForm")
					.attr("action", "${ctx}/expfetch/acptredraw/cancelexpertresult");
			$("#inputForm").submit();
			return false;
		}

		function bCancel() {
			$("#inputForm").attr("action", "${ctx}/expfetch/acptredraw/backexpmethod");
			$("#inputForm").submit();
			return false;
		}
