...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/experts/workinfo">职业信息</a></li>
		<li><a href="${ctx}/experts/applyinfo">申报信息</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="expertInfo" action="${ctx}/experts/savework" method="post" class="form-horizontal">
