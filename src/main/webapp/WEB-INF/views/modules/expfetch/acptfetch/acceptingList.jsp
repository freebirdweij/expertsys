...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
			$("#pageNo").val(n);
			$("#pageSize").val(s);
			$("#searchForm").attr("action","${ctx}/expfetch/acptfetch/acceptinglist");
			$("#searchForm").submit();
	    	return false;
	    }
	</script>
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/expfetch/acptfetch/acceptinglist">待交工验收项目</a></li>
		<li><a href="${ctx}/expfetch/savefetch/saveinglist">待竣工验收项目</a></li>
	</ul>
	<form:form id="inputForm" modelAttribute="projectExpert" action="${ctx}/expfetch/acptfetch/unitmethod" method="post" class="form-horizontal">
	<tags:message content="${message}"/>
		<form:hidden path="prjid"/>
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th>项目编号</th><th>项目名称</th><th>建设单位</th><th>状态</th><th>投资金额</th><th>项目年度</th><th>抽取选择</th><th>是否结束</th></tr></thead>
		<tbody>
