		...
		$(document).ready(function() {
			...
			$("#resSubmit").click(function(){
				top.$.jBox.confirm("确返回吗？","系统提示",function(v,h,f){
					if(v=="ok"){
						$("#inputForm").attr("action","${ctx}/expfetch/acptredraw/backexpresult");
						$("#inputForm").submit();
					}
				},{buttonsFocus:1});
				top.$('.jbox-body .jbox-icon').css('top','55px');
...
<body>
	...
	<form:form id="inputForm" modelAttribute="projectExpert" action="${ctx}/expfetch/acptredraw/drawexpert" method="post" class="form-horizontal">
