...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
			$("#pageNo").val(n);
			$("#pageSize").val(s);
			$("#searchForm").attr("action","${ctx}/expfetch/reviewinglist");
			$("#searchForm").submit();
	    	return false;
	    }
	</script>
...
<body>
	...
	<form:form id="inputForm" modelAttribute="projectExpert" action="${ctx}/expfetch/unitmethod" method="post" class="form-horizontal">
