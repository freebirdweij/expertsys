...
<head>
	...
	<script type="text/javascript">
		...
		function rSubmit(){
			$("#inputForm").attr("action","${ctx}/expfetch/savredraw/export");
			$("#inputForm").submit();
	    	return false;
	    }
		...
		function bCancel(){
			$("#inputForm").attr("action","${ctx}/expfetch/savredraw/saveinglist");
			$("#inputForm").submit();
	    	return false;
	    }
...
<body>
	...
	<form:form id="inputForm" modelAttribute="projectExpert" action="${ctx}/expfetch/savredraw/directdrawunit" method="post" enctype="multipart/form-data" class="form-horizontal">
