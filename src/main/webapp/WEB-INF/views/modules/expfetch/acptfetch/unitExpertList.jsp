...
<head>
	...
	<script type="text/javascript">
		...
		function resBack(){
			$("#inputForm").attr("action","${ctx}/expfetch/acptfetch/backunitresult");
			$("#inputForm").submit();
	    	return false;
	    }
...
<body>
	...
	<form:form id="inputForm" modelAttribute="projectExpert" action="${ctx}/expfetch/acptfetch/drawunitexpert" method="post" class="form-horizontal">
